...
final characteristicUUID = {
  ...
  "henXuanSend": "00000814-0000-1000-8000-00805f9b34fb", //hen xuan
  "henXuanNotify": "00000813-0000-1000-8000-00805f9b34fb", //hen xuan
  "vcSend": "2D420003-6569-6464-6163-6563696F562D", //VC
  "vcNotify": "2D420002-6569-6464-6163-6563696F562D", //VC
  "notify": [
    "00000af7-0000-1000-8000-00805f9b34fb",
    "00000af2-0000-1000-8000-00805f9b34fb",
    "00001531-1212-EFDE-1523-785FEABCD123",
    "00000813-0000-1000-8000-00805f9b34fb", //hen xuan
    "2D420002-6569-6464-6163-6563696F562D" //VC
  ]
};

//ido 主服务
const idoMainServiceUUID = "00000af0-0000-1000-8000-00805f9b34fb";

//思澈设备主服务
const siceMainService = "00000000-0000-0000-6473-5f696c666973";
...
//设置配对指令
final openPairCommend = Uint8List.fromList([
  0x03,
  0x30,
  0x55,
  0x00,
